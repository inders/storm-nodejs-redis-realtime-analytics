...
=======
    // Tweets from twitter sport
    // TODO: setup your twitter credentials
    TwitterSampleSpout twitterSpout = new TwitterSampleSpout("<username>", "<password>");
    builder.setSpout("twitter", twitterSpout);
>>>>>>> 15f367401362bfcf4bd753b7a29ff43b41512ee5
    ...
    // Retweets
    builder.setBolt("retweets", new RedisRetweetBolt(2), 2).shuffleGrouping("filter");
